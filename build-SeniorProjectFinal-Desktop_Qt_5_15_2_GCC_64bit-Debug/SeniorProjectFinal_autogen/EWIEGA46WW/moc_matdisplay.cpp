...
#include <memory>
#include "../../../SeniorProjectFinal/matdisplay.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_matDisplay_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_matDisplay_t qt_meta_stringdata_matDisplay = {
    {
QT_MOC_LITERAL(0, 0, 10), // "matDisplay"
QT_MOC_LITERAL(1, 11, 17), // "sendMousePosition"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7) // "QPoint&"

    },
    "matDisplay\0sendMousePosition\0\0QPoint&"
};
...
void *matDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_matDisplay.stringdata0))
